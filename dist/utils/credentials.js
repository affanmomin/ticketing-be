...
exports.frontendCredentialUtils = void 0;
exports.decodeCredentials = decodeCredentials;
exports.encodeCredentials = encodeCredentials;
exports.extractCredentialsFromUrl = extractCredentialsFromUrl;
/**
 ...
 */
function decodeCredentials(encodedCreds) {
    try {
...
exports.frontendCredentialUtils = {
     ...
     */
    extractCredentialsFromCurrentUrl() {
        try {
